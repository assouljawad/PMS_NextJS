...
function BeautyCard() {
  return (
    <div className="hover:drop-shadow-2xl bg-[url('/beauty.jpg')] bg-cover h-[500px] w-[380px] rounded-xl transition ease-in-out delay-160  hover:-translate-y-1 hover:scale-100 duration-200 cursor-pointer">
